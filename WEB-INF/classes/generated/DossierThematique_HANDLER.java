...
// Generation date: Sun Mar 15 00:58:09 CET 2015
...
public class DossierThematique_HANDLER implements com.jalios.jstore.StorableHandler {

  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    DossierThematique handler = (generated.DossierThematique)storable;
    String value;
    Map attributes = sle.getAttributes();
    value = (String)attributes.get("titreAffiche");
    if (value != null) {
      handler.setTitreAffiche((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "titreAffiche")));
    }

    value = (String)attributes.get("titreAfficheML");
    if (value != null) {
      handler.setTitreAfficheML((java.util.HashMap)StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "titreAfficheML")));
    }
    ...
    value = (String)attributes.get("contenu");
    if (value != null) {
      handler.setContenu((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "contenu")));
    }

    value = (String)attributes.get("contenuML");
    if (value != null) {
      handler.setContenuML((java.util.HashMap)StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "contenuML")));
    }

    value = (String)attributes.get("lienArticle");
    if (value != null) {
      handler.setLienArticle((generated.Article[])StoreUtil.decodeObject(generated.Article[].class, value, store, new DecodeContext(sle, "lienArticle")));
    }
  ...
  public Map getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.DossierThematique handler = (generated.DossierThematique)storable;
    Map attributes = new HashMap();
    attributes.put("titreAffiche", StoreUtil.encodeObject(handler.getTitreAffiche(), store));
    attributes.put("titreAfficheML", StoreUtil.encodeObject(handler.getTitreAfficheML(), store));
    ...
    attributes.put("contenu", StoreUtil.encodeObject(handler.getContenu(), store));
    attributes.put("contenuML", StoreUtil.encodeObject(handler.getContenuML(), store));
    attributes.put("lienArticle", StoreUtil.encodeObject(handler.getLienArticle(), store));
