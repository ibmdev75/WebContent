...
%><%--
  @Summary: DossierThematique editor
  @Category: Generated
...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditDossierThematiqueHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/DossierThematique/editDossierThematiqueModal.jsp">
<div class="row DossierThematique">
	<%-- Title ------------------------------------------------------------ --%>
	...
	<% } %>
	<jalios:include jsp="types/DossierThematique/doEditDossierThematiqueModal.jsp" />
</div>
</jalios:modal>
<% 
